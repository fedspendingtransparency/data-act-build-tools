...
docker build -t $ACCOUNT.dkr.ecr.us-gov-west-1.amazonaws.com/mimir:$ENV_DISPLAYNAME -f Dockerfile .
docker push $ACCOUNT.dkr.ecr.us-gov-west-1.amazonaws.com/mimir:$ENV_DISPLAYNAME