...
docker build -t $ACCOUNT.dkr.ecr.us-gov-west-1.amazonaws.com/prometheus:$ENV_DISPLAYNAME --build-arg token=$TOKEN -f Dockerfile .
docker push $ACCOUNT.dkr.ecr.us-gov-west-1.amazonaws.com/prometheus:$ENV_DISPLAYNAME